...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      <h4 class="text-primary p-3">Please fill out all fields</h4>
   </div>';
   }else{
      ...
      if($upload){
         ...
         $message[] = '<div class="d-flex align-items-center justify-content-center">
         <h4 class="text-success p-3">A New Product added successfully</h4>
      </div>';
      }else{
         $message[] = '<div class="d-flex align-items-center justify-content-center">
...
<div class="d-flex align-items-center justify-content-center" style="background-color:#eee; margin-top:40px; margin-bottom:40px;">
   <h1 class="text-dark m-4">Add New Product Page</h1>
</div>
<div style="background-color:#eee; margin-top:40px; margin-bottom:40px;">
<div id="addform" class="container col-6 mt-4">
   <div class="modal-body">

      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" class="bg-dark p-4">
      <div class="d-flex align-items-center justify-content-center">
         ...
         <div class="">
            <input type="submit" class="btn btn-success form-control" name="add_product" value="Add Product">
         </div>
      </form>
